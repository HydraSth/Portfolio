...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="scroll-snap-section min-h-screen flex items-center justify-center relative py-16">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          {/* Text Content */}
          <div className="text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-foreground mb-6 text-balance">
              Hola, soy <span className="gradient-green-text font-normal">Juan Cruz</span>
            </h1>

            <p className="text-lg md:text-xl text-muted-foreground mb-8 text-pretty font-light leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 mb-12">
              <button
                ...
                className="px-8 py-3 bg-accent hover:bg-accent/80 text-white border-0 rounded-md font-light transition-colors"
              >
                Ver mi Trabajo
              </button>
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 mx-auto lg:mx-0">
            <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 to-green-700/20 rounded-full blur-2xl -z-10 animate-float"></div>
            <img 
              src={Retrato} 
              alt="Juan Cruz" 
